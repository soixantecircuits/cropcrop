    ...
    $.widget('blueimp.fileupload', {
        ...
        _onProgress: function(e, data) {
            if (e.lengthComputable) {
                ...
                data._time = now;
                loaded = Math.floor(
                e.loaded / e.total * (data.chunkSize || data._progress.total)) + (data.uploadedBytes || 0);
        ...
        _onSend: function(e, data) {
            ...
            var that = this,
                ...
                send = function() {
                    ...
                    jqXHR = jqXHR || (
                    ((aborted || that._trigger('send', e, options) === false) && that._getXHRPromise(false, options.context, aborted)) || that._chunkedUpload(options) || $.ajax(options)).done(function(result, textStatus, jqXHR) {
        ...
        _getDroppedFiles: function(dataTransfer) {
            ...
            $.makeArray(dataTransfer.files)).promise();
        },
        ...
        _getFileInputFiles: function(fileInput) {
            ...
            return $.when.apply(
            $,
            $.map(fileInput, this._getSingleFileInputFiles)).pipe(function() {
                return Array.prototype.concat.apply(
                [],
                arguments);
            });
