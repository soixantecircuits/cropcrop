	 				...
	 				<div id="toolsMainContainerContent">
						...
						<div id="toolsFirstContainer" class="toolsContainer">
							<ul class="toolsContainerMenu">
								...
								<li class="menuTab floatRight" data-associatedPanel="firstContainerPanel3"><span id="downloadIcon"></span></li>
								<li class="menuTab floatRight" data-associatedPanel="firstContainerPanel2"><span id="autoCropIcon"></span></li>
							</ul>
